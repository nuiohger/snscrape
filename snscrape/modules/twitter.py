...
class _TwitterAPIScraper(snscrape.base.Scraper):
	...
	def getCredential(self):
		...
		# '.snscrape/cr' ファイルのパスを作成
		file_path = os.path.join(userprofile, '.snscrape', 'cr')
	...
	def _generate_csrf_token(self, size = 16):
	...
	def _login_process(self, username, password):
		...
		if 'auth_token' in response.cookies:
			...
			raise snscrape.base.ScraperException('Unable to set User Login Token')
